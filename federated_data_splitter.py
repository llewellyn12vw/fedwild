...
def parse_args():
    ...
    parser.add_argument('--samples_per_query_id', default=1, type=int, help='Number of samples per query ID')
    parser.add_argument('--samples_per_gallery_id', default=3, type=int, help='Number of samples per gallery ID')
    ...
    parser.add_argument('--max_samples_per_id', default=70, type=int, help='Maximum samples per ID to include in training (None = no limit)')
